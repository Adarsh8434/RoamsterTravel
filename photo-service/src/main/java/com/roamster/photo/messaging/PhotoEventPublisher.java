package com.roamster.photo.messaging;
...
public class PhotoEventPublisher {
    ...
    public static final String KEY_REC_GEN = "photo.recommendation.generated";
    ...
    public void publishRecommendationGenerated(Long recommendationId, Long tripId) {
        ...
        payload.put("category", "PHOTO");
        log.info("Publishing photo recommendation event: {}", payload);
